...
import NutritionCoachMemoriesCard from './NutritionCoachMemoriesCard';
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(14rem,20rem)_1fr]">
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-2 border-t pt-3">
              <Label htmlFor="nutrition-coach-title">
                {t(
                  'training.nutritionCoach.newTitle',
                  'Title (optional)'
                )}
              </Label>
              <Input
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="max-h-[min(420px,50vh)] space-y-3 overflow-y-auto">
